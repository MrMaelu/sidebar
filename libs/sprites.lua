	...
	if (sprite ~= nil) then
		...
		for _,v in pairs(renderInfo) do
			if (v.visible and v.texture ~= nil) then
				...
				v.vec_position.x = v.position_x * settings.Theme.Scale;
				v.vec_position.y = v.position_y * settings.Theme.Scale;
				v.vec_scale.x = v.scale_x * settings.Theme.Scale;
				v.vec_scale.y = v.scale_y * settings.Theme.Scale;
